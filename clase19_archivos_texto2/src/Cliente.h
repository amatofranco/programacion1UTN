...
int cli_guardarArrayEnArchivo(Cliente *arrayPunteros[], int length, char *pathArchivo);

int cli_leerArrayEnArchivo(Cliente *arrayPunteros[], int length, char *pathArchivo);
int cli_agregarAlArrayTxt(Cliente *arrayPunteros[], int length, char *nombre, char *altura, char *dni, char *id);
