...
/**
 * Toma los elementos de la lista y los pasa por una funcion que los modifica
 * @param this Puntero a la lista
 * @param pFunc Funcion para modificar el elemento
...
/**
 * Filtra los elementos de una lista segun condicion
 ...
 * que cumplan con la condicion de la funcion pasada como parametro
 * @param this Puntero a la lista
 * @param fn Funcion con condicion para contar
 * @return Cantidad de elementos contados o -1 en caso de Error
 */
